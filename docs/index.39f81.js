System.register(["./application.261b8.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_application261b8Js) {
      createApplication = _application261b8Js.createApplication;
    }],
    execute: function () {
      createApplication({
